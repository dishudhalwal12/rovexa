...
- **Global scope**: `/Users/divyanshusaini/Downloads/Rovexa v2/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/divyanshusaini/Downloads/Rovexa v2/.codex/notes/`)
...
2. Glob `/Users/divyanshusaini/Downloads/Rovexa v2/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/divyanshusaini/Downloads/Rovexa v2/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/divyanshusaini/Downloads/Rovexa v2/.codex/notes/` — works in any directory
